 ...
 * <p>Members:
 * <ul>
 *   <li>{@link dev.reddragon.analytics.propagation.NarrativeExpansionScorer}
 *       — narrative breadth and coherence growth</li>
 *   <li>{@link dev.reddragon.analytics.propagation.PropagationPhaseAnalyzer}
 *       — labels propagation as early / accelerating / saturated</li>
 *   <li>{@link dev.reddragon.analytics.propagation.ReflexivityScorer}
 *       — feedback-loop intensity between price and attention</li>
 *   <li>{@link dev.reddragon.analytics.propagation.SectorPropagationScorer}
