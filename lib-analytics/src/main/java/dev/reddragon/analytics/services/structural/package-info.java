 ...
 * the higher-level orchestrator in {@link dev.reddragon.analytics.services}.
 *
 * <p>Members:
 * <ul>
 *   <li>{@link dev.reddragon.analytics.services.structural.AdversarialValidationAnalyzer}
 *       — finds contradictions in the bullish thesis</li>
 *   <li>{@link dev.reddragon.analytics.services.structural.AsymmetryScorer}
 *       — measures remaining risk/reward asymmetry</li>
 *   <li>{@link dev.reddragon.analytics.services.structural.DilutionRiskScorer}
 *       — scores dilution / share-issuance risk</li>
 *   <li>{@link dev.reddragon.analytics.services.structural.MaterialityImpactScorer}
