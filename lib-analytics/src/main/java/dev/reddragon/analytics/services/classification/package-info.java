 ...
 * {@link dev.reddragon.analytics.services} blends these into a regime label.
 *
 * <p>Members:
 * <ul>
 *   <li>{@link dev.reddragon.analytics.services.classification.EquilibriumQualityScorer}
 *       — how well-behaved is mean reversion right now</li>
 *   <li>{@link dev.reddragon.analytics.services.classification.EquilibriumPhaseAnalyzer}
 *       — labels the current intraday phase (used by Layer 7 exit logic too)</li>
 *   <li>{@link dev.reddragon.analytics.services.classification.DirectionalPersistenceScorer}
 *       — how trendy / persistent is the move</li>
 *   <li>{@link dev.reddragon.analytics.services.classification.VolatilityExpansionScorer}
 *       — is realized volatility expanding</li>
 *   <li>{@link dev.reddragon.analytics.services.classification.VwapInteractionScorer}
 *       — how price is interacting with VWAP</li>
 *   <li>{@link dev.reddragon.analytics.services.classification.LiquidityTextureScorer}
 *       — depth, spread, and participation quality</li>
 *   <li>{@link dev.reddragon.analytics.services.classification.OptionsFlowScorer}
 *       — unusual options activity intensity</li>
 *   <li>{@link dev.reddragon.analytics.services.classification.RegimeCompatibilityScorer}
