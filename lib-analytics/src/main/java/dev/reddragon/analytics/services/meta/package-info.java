 ...
 * <p>Members:
 * <ul>
 *   <li>{@link dev.reddragon.analytics.services.meta.LiveContextAdaptationAnalyzer}
 *       — adapts active context (e.g. dampens scores when regime is hostile)</li>
 *   <li>{@link dev.reddragon.analytics.services.meta.LongHorizonCalibrationAnalyzer}
