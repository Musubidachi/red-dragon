 ...
 * {@link dev.reddragon.validation.services.engine.DeploymentResolver}. The scorer in
 * this package supplies one of its inputs — a 0.0–1.0 confidence number.
 *
 * <p>Members:
 * <ul>
 *   <li>{@link dev.reddragon.analytics.services.deployment.DeploymentConfidenceScorer}
