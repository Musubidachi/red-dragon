 ...
 *
 * <p>Two-stage pipeline inside {@link dev.reddragon.validation.engine}:
 * <ol>
 *   <li><b>Hard gates</b> — deterministic rejections evaluated by
 *       {@link dev.reddragon.validation.engine.HardGateEvaluator} (minimum
 ...
 *       {@link dev.reddragon.validation.engine.DisequilibriumValidationEngine}
 *       blends the analytics layer's seven dimensions into a final PASS /
 *       WATCH / REJECT verdict via
 *       {@link dev.reddragon.validation.engine.VerdictResolver}, then
 *       {@link dev.reddragon.validation.engine.DeploymentResolver} assigns
